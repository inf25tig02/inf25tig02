document.addEventListener("DOMContentLoaded", function() {
        ...
        formulario.addEventListener("submit", function(event) {
            ...
            formulario.innerHTML = `
                <div style="background-color: #1e293b; padding: 30px; border-radius: 8px; text-align: center; border: 2px solid #38bdf8; color: #f8fafc;">
                    ...
                    <p style="font-size: 1.1em;">Muito obrigado pela sua opinião.</p>
                </div>
            `;
        });
    }
    ...
    if (xmlTableBody) {
        ...
        <catalogo>
            <jogo id="j01"><titulo>Dragon Ball Z Budokai Tenkaichi 3</titulo><consola>PlayStation 2</consola><ano>2007</ano><genero>Luta</genero><produtora>Spike</produtora></jogo>
            <jogo id="j02"><titulo>Digimon World</titulo><consola>PlayStation</consola><ano>2001</ano><genero>RPG</genero><produtora>Bandai</produtora></jogo>
            <jogo id="j03"><titulo>Pokémon Silver</titulo><consola>Game Boy Color</consola><ano>2001</ano><genero>RPG</genero><produtora>Game Freak</produtora></jogo>
            <jogo id="j04"><titulo>Yu-Gi-Oh Forbidden Memories</titulo><consola>Playstation</consola><ano>2002</ano><genero>Cartas</genero><produtora>Konami</produtora></jogo>
        </catalogo>`;
